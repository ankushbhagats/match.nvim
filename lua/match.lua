...
local function float(title, row, parent)
  ...
  vim.wo[win].winhl = string.format("NormalFloat:Normal,FloatBorder:%s,Search:None,IncSearch:None,CurSearch:None", opts.border_hl)
...
vim.api.nvim_create_user_command("Match", function()
  open()
